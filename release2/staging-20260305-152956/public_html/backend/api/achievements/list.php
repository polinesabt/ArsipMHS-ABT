...
try {
    ...
    $query = "
        SELECT 
            ...
            {$psJenisPerolehanExpr} AS jenis_perolehan,
            COALESCE({$psNamaDosenExpr}, {$ppPeranPenulisExpr}) AS nama_dosen,
            ...
            COALESCE({$psUrlPublikasiExpr}, {$ppUrlExpr}) AS url_publikasi
        FROM achievements a

        ...
        <SheetContent className="sm:max-w-md overflow-y-auto bg-card/95 backdrop-blur-xl border-l border-border/40 text-foreground">
          ...
          {selectedDosen && (
            <div className="space-y-6 pt-6">
              ...
              {/* Section 2: Kualifikasi & Sertifikasi */}
              <div className="space-y-4 pt-4 border-t border-border/30">
                <h5 className="text-xs font-bold uppercase tracking-wider text-primary/80">Kualifikasi & Sertifikasi</h5>
                
                {/* Pendidikan Pasca Sarjana */}
                <div className="space-y-2">
                  <p className="text-xs text-muted-foreground font-medium">Pendidikan Pasca Sarjana</p>
                  <div className="flex gap-2">
                    {/* NOTE: Tombol interaktif untuk memilih kualifikasi pasca sarjana (Magister / Doktor). 
                        Pengembangan fitur klik untuk saat ini belum diaktifkan sesuai instruksi. */}
                    <button 
                      type="button"
                    ...
                    <button 
                      type="button"
                      className={`flex-1 py-1.5 px-3 rounded-xl text-xs font-semibold transition-all ${
                        selectedDosen.pendidikanPascaSarjana === 'Doktor'
                          ? 'bg-primary text-primary-foreground shadow-md'
                          : 'bg-muted/50 text-muted-foreground border border-border/50 hover:bg-muted/80'
                      }`}
                    >
                ...
                <div className="space-y-3 pt-1">
                  ...
                  <div className="p-3 rounded-xl bg-muted/20 border border-border/30">
                    ...
                    <p className="font-semibold text-foreground mt-0.5 font-mono flex items-center gap-1.5 text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-muted/20 border border-border/30">
                    <p className="text-xs text-muted-foreground">Sertifikat Kompetensi / Profesi / Industri</p>
              ...
              <div className="space-y-3 pt-4 border-t border-border/30">
                <h5 className="text-xs font-bold uppercase tracking-wider text-primary/80">Kontak Dosen</h5>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-muted-foreground" />
                    <span>{selectedDosen.email}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Phone className="w-4 h-4 text-muted-foreground" />
                    <span>{selectedDosen.telepon}</span>
                  </div>
                </div>
              </div>
            </div>

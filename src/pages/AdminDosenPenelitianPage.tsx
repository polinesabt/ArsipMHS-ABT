...
export default function AdminDosenPenelitianPage() {
  ...
  const handleSave = () => {
    ...
    updateKontribusiPenelitian(finalData.nidn, finalData);
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Middle: Penelitian Preview Chips (Aligned Column, Auto Sizing & Smooth Crossfade) */}
                    ...
                    <AnimatePresence mode="wait" initial={false}>
                      {!isExpanded ? (
                        ...
                        >
                          {previewChips.map((p) => (
                            <span
                              ...
                              title={p.judul}
                            >
                              <FlaskConical className="w-3 h-3 text-primary/70 shrink-0" />
                        ...
                        >
                          ...
                          <span>Menampilkan detail lengkap penelitian & rekognisi dosen</span>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </div>

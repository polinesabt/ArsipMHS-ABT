...
export default function AdminDosenKontribusiPage() {
  ...
  const handleSave = async () => {
    ...
    await updateKontribusiPengajaran(finalData.nidn, finalData);
  ...
  return (
    <div className="space-y-6 pb-14 font-sans selection:bg-primary/20 selection:text-primary">
      <div className="flex justify-end gap-2"><DosenImportLogsButton /><DosenImportButton module="pengajaran" title="Kontribusi Pengajaran" /></div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Bottom Tier: Matkul Preview Chips (When Collapsed) */}
                    ...
                    {!isExpanded ? (
                      ...
                      >
                        <span className="text-[11px] font-medium text-muted-foreground mr-1 flex items-center gap-1 shrink-0">
                          <BookOpen className="w-3 h-3 text-muted-foreground/80" />
                          Mata kuliah diampu:
                        </span>
                        {previewChips.map((mk) => (
                          <span
                          ...
                          >
                            ...
                            <span className="text-[10px] opacity-70">({mk.sks} SKS)</span>
                          </span>
                        ))}
            ...
            <>
              ...
              <div className="p-6 space-y-6 flex-1">
                ...
                <div className="p-4 rounded-xl bg-card border border-border/70 space-y-3">
                  ...
                  <div className="rounded-xl border border-border/70 overflow-x-auto bg-background">
              ...
              {/* Sheet Sticky Footer */}
              <div className="p-4 pb-[max(1rem,env(safe-area-inset-bottom))] border-t border-border/60 bg-muted/20 sticky bottom-0 z-10 flex items-center justify-end gap-2.5 backdrop-blur-md">
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
